...
# output folder
fs::dir_create("../output/WGCNA_acetyl")
out_path_base <- "../output/WGCNA_acetyl"
...
fs::dir_create(glue("../output/WGCNA_acetyl/softPower_{softPower}"))
out_path <- paste0("../output/WGCNA_acetyl/softPower_", softPower)
