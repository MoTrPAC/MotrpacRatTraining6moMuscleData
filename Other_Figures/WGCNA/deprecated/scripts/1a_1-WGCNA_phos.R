...
# output folder
fs::dir_create("../output/WGCNA_phos")
out_path_base <- "../output/WGCNA_phos"
...
fs::dir_create(glue("../output/WGCNA_phos/softPower_{softPower}"))
out_path <- paste0("../output/WGCNA_phos/softPower_", softPower)
