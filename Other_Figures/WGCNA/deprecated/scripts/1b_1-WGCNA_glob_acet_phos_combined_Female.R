...
# output folder
fs::dir_create("../output/WGCNA_combined_Female")
out_path_base <- "../output/WGCNA_combined_Female"
...
m4 <- filter_by_occurrence(m4, 0.6)
...
fs::dir_create(glue("../output/WGCNA_combined_Female/softPower_{softPower}"))
out_path <- paste0("../output/WGCNA_combined_Female/softPower_", softPower)
