...
# output folder
fs::dir_create("../output/WGCNA_redox")
out_path_base <- "../output/WGCNA_redox"
...
fs::dir_create(glue("../output/WGCNA_redox/softPower_{softPower}"))
out_path <- paste0("../output/WGCNA_redox/softPower_", softPower)
