...
#'   \code{\link[limma:removeBatchEffect]{limma::removeBatchEffect}}.
#'
#' @keywords datasets
#'
#' @name SKM_EXP
...
#'   with \code{\link[TMSig]{filter_sets}} and only keeping those sets with at
...
#'   \code{\link[TMSig]{cluster_sets}} with default parameters. These tend to be
